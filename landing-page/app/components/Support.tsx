      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <div className="mt-4 inline-flex w-full mt-6 sm:w-auto">
                    <a href="#" className="inline-flex items-center justify-center w-full py-2 px-4 text-white font-medium duration-150 hover:bg-gray-700 active:bg-gray-900 rounded-lg hover:shadow-none bg-tertiary">
