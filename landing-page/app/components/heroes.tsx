      ...
      >
        ...
        <div className="mt-4 relative isolate px-6 pt-0 lg:px-10">
          <div className="mx-auto max-w-5xl py-32 sm:py-48 lg:py-41">
            ...
            <a href="#" className="inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-white bg-gray-800 rounded-full  dark:text-white hover:bg-gray-200" role="alert"style={{background:"inherit",border:"1px solid",borderColor:"gray"}}>
                <span className="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3"style={{background:"#E5DCF3",color:"black"}}>New</span> <span className="text-sm font-medium">NestSite is out! See what&apos;s new</span> 
            ...
            <h1 className="text-4xl sm:text-4xl md:text-6xl lg:text-7xl font-[900] tracking-tight text-white animate__animated animate__bounce heading">
              Create,<br/> Share and Build <br/> Your Stellar World.
            </h1>

              <p className="mt-6 text-lg leading-8 text-gray-400 ">No code needed.<br></br> It only takes a few minutes.✨</p>
            ...
            {/* Wrap Get started in lg:flex */}
              ...
              <div className="flex justify-center items-center pt-6 gap-x-4 text-gray-400 text-md">
                            ...
                            <p><span className="text-gray-100">5.0</span> by over 1000 creators</p>
                        </div>
            </div>
          </div>
          <div
