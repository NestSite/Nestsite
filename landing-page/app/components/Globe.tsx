...
<section className="bg-[#f8f8fa] mx-5 lg:mx-20 rounded-3xl border border-gray-50">
  <div className="gap-4 items-center py-2 px-0 max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2  lg:px-20">
    <div className="mt-0 md:mt-0">
      <h2 className="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-[#6E0BF0] mt-4">Sell to anyone, anywhere and anytime.</h2>
      <p className="mb-6 font-light text-gray-800 md:text-lg">
     
      <p className="mb-4 text-gray-500">
        Recieve and monetize your contents and skills on Nestsite seamlessly, sell to customers from different parts of the world  and get paid for your work in multiple currencies including USD, GBP, and EUR.
      </p>
