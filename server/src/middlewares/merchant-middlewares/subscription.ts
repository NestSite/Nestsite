...
export const checkSubscriptionPlan = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const checkMaxStoresLimit = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const checkMaxProductsPerStoreLimit = async (req: Request, res: Response, next: NextFunction) => {
    try {
