...
import CreateVehicleDialog from "../_components/CreateVehicleDialog.dialog";
...
export default function Vehicles() {
  ...
  return (
    ...
    <div className="flex flex-col self-stretch px-16 mt-8 max-md:px-5 max-md:max-w-full">
      ...
      <AdminPageHeader title="List Builder / Vehicles" />
      ...
      <div className="flex flex-col mt-6 leading-[140%] max-md:max-w-full">
        ...
        <BaseTable data={data} columns={vehicleColumns} />
      </div>
