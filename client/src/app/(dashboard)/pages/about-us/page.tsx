            ...
            <div className="flex flex-col w-full gap-6 mt-4 bg-white rounded-xl py-8 px-4 items center">
                <div className="flex w-full items-center justify-between">
                    ...
                    <div className="flex gap-4 items-center">
                        <EditDialog title="About Us">
                            <Button className="flex items-center text-primary font-bolf w-fit h-full gap-3 py-4" variant="outline" >
                                <Edit size={'1.1rem'} color="#1691B2" />
                                Edit Page
                            </Button>
                        </EditDialog>
                        <AddDialog title="About Us">
                ...
                <div className="flex flex-col">
                    <h2 className="text-[#424242] font-bold text-2xl">About Us</h2>
                    <p>
