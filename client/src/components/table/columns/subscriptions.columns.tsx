...
export const subscriptionColumns = [
    ...
    subscriptionColumnHelper.accessor("plan", {
        ...
        sortingFn: "text",
        cell: (info) => <span className="capitalize whitespace-nowrap">{info.getValue()?.type?.toString()}</span>,
    }),
    ...
    subscriptionColumnHelper.accessor("plan", {
        ...
        sortingFn: "text",
        cell: (info) => <span className="capitalize whitespace-nowrap">{info.getValue()?.duration?.toString()}</span>,
    }),
    subscriptionColumnHelper.accessor("plan.startAt", {
        header: ({ column }) => <Header title="Start Date" column={column} />,

        sortingFn: "text",
        cell: (info) => <span className="capitalize whitespace-nowrap">{info.getValue()?.toString()}</span>,
    }),
    ...
    subscriptionColumnHelper.accessor("plan", {
        ...
        sortingFn: "text",
        cell: (info) => <span className="capitalize whitespace-nowrap">${info.getValue()?.amount?.toString()}</span>,
    }),
