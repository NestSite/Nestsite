...
import CreateRoleDialog from "@/app/(dashboard)/roles/_components/CreateRole.dialog";
...
export const taskerTitleColumns = [
    ...
    taskerTitleColumnHelper.accessor("specialties", {
        header: ({ column }) => <Header title="Tasker Specialties" column={column} />,
